...
// Объект Rectangle2D.Double, указывающий диапазона комплексной
        ...
        privateJComboBox<FractalGenerator>comboBox;
...
/*
МетодsetGUI(), которыйинициализирует
...
// Закрытияокнапоумолчанию.
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

/*
Данныеоперацииправильноразметятсодержимоеокна, сделаютего
видимымизатемзапретятизменениеразмеровокна:
         */
        frame.pack();
...
// ОтрисовкафракталавJImageDisplay.
...
// Внутреннийклассдляобработкисобытийjava.awt.event.MouseListenerсдисплея.
